...
function vModel(self, dataObject, defaultValue) {
  dataObject.props.modelValue = defaultValue
...
const componentChild = {
  ...
  'el-upload': {
    'list-type': (h, conf, key) => {
      ...
      if (conf.showTip) {
        list.push(<div class="el-upload__tip">只能上传不超过 {conf.fileSize}{conf.sizeUnit} 的{conf.accept}文件</div>)
      }
      return list
    }
  }
