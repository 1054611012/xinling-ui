<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="providerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="提供商ID" align="center" prop="providerId" width="80" show-overflow-tooltip />
      <el-table-column label="提供商名称" align="center" prop="providerName" :show-overflow-tooltip="true" />
      <el-table-column label="提供商编码" align="center" prop="providerCode" show-overflow-tooltip />
      <el-table-column label="提供商类型" align="center" prop="providerType" width="100" show-overflow-tooltip>
...
function getList() {
  withLoading(loading, listProvider(queryParams)).then(response => {
